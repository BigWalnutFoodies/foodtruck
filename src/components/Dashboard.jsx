...
const s = {
  ...
  filters:     { display: 'flex', flexDirection: 'column', gap: '0.5rem', marginBottom: '1rem', background: '#fff', border: '1px solid #e8e0d0', borderRadius: 10, padding: '0.9rem 1.1rem', overflow: 'hidden' },
  filterRow:   { display: 'flex', alignItems: 'center', gap: '0.5rem', minWidth: 0 },
  filterScroll:{ display: 'flex', gap: '0.4rem', overflowX: 'auto', flexWrap: 'nowrap', paddingBottom: 4, WebkitOverflowScrolling: 'touch', flex: 1, minWidth: 0 },
