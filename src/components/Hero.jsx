  ...
  return (
    <section style={styles.hero}>
      <div style={styles.inner}>
        ...
        <h1 style={styles.h1}>
          Bring Your Truck<br />
          <span style={styles.accent}>To Our Pop-Up</span>
        </h1>
        <p style={styles.p}>
          Check available dates, submit your info, and we'll confirm your spot.
          Simple, fast, no back-and-forth emails.
        </p>
        <div style={styles.btnRow}>
          <button style={styles.btnPrimary} onClick={() => setView('book')}>
            Request a Date →
          </button>
        ...
        <div style={styles.pills}>
          {['Free to apply', 'Response within 24hrs', 'SMS + Email notifications', 'Easy approval process'].map(t => (
...
const styles = {
  ...
  tag: {
    ...
    color: '#ff5c1a', fontSize: '0.78rem', fontWeight: 700,
    letterSpacing: 1, textTransform: 'uppercase',
    padding: '0.35rem 1rem', borderRadius: 100, marginBottom: '1.5rem',
  },
  h1: {
    fontFamily: "'Syne', sans-serif", fontWeight: 800,
    fontSize: 'clamp(2.4rem, 5vw, 3.8rem)',
    lineHeight: 1.05, marginBottom: '1.2rem', color: '#1a1208',
  },
  accent: { color: '#ff5c1a' },
  p: {
    color: '#8a7f6e', fontSize: '1rem', lineHeight: 1.7,
  ...
  btnPrimary: {
    ...
    padding: '0.85rem 1.8rem', fontWeight: 700,
    fontSize: '1rem', cursor: 'pointer',
  },
  btnSecondary: {
    background: '#fff', color: '#1a1208',
    border: '1.5px solid #e8e0d0', borderRadius: 10,
    padding: '0.85rem 1.8rem', fontWeight: 600,
    fontSize: '1rem', cursor: 'pointer',
  },
  pills: { display: 'flex', gap: '0.6rem', flexWrap: 'wrap' },
  pill: {
    background: '#f0faf4', border: '1px solid #b8e8cc',
    color: '#22a05a', fontSize: '0.78rem', fontWeight: 600,
  ...
  illustration: {
    ...
    borderRadius: '50%', border: '2px solid #ffd0b0',
  ...
  spark: {
    position: 'absolute', color: '#ffb800',
    fontSize: '1.2rem',
